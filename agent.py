...
class Agent:
    ...
    def __init__(self, state_size, action_size, seed, DQN, dqn_save_path='./trained_agent.pth', hyperparameters=DQNHyperparameters()):
        """
        Params
        ======
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        In the case of the DQN:
        1. Save the most recently acquired experience tuple into the replay memory.
        2. Every UPDATE_EVERY steps, have the current DQN learn from a minibatch of experience tuples.
    ...
    def _current_dqn_forward_pass(self, states):
        ...
        through the current DQN with gradient calculations turned off.
